...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'header'=>'Wallet Type',
            'filter' => Html::activeDropDownList($searchModel, 'wallet_type_id', \yii\helpers\ArrayHelper::map([null=>'All']+\app\models\wallet\WalletType::getAvailableWalletTypes(),'id','display_name'))
        ],

        [
            'attribute'=>'lnNode.alias',
            'header'=>'LN Node',
            'filter' => Html::activeDropDownList($searchModel, 'ln_node_id', \yii\helpers\ArrayHelper::map([null=>'All']+Yii::$app->user->identity->lnNodes,'id','alias'))
        ],
        //'external_hash',
        //'json_data',

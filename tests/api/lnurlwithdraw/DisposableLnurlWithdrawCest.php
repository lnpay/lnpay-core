 ...
 * @group base_api
 */
class DisposableLnurlWithdrawCest
{
    ...
    public function getDisposableLnurlWithdrawSuccessSak(\ApiTester $I)
    {
        ...
        $I->sendGET('/v1/wallet/wal_aliceLnurlWithdraw/lnurl/withdraw?memo=Tester&num_satoshis=69&passThru='.$arbData);
    ...
    public function getDisposableLnurlWithdrawSuccessPak(\ApiTester $I)
    {
        ...
        $I->sendGET('/v1/wallet/waklw_aliceLnurlWithdraw/lnurl/withdraw');
        $I->seeResponseCodeIs(\Codeception\Util\HttpCode::OK);
        $I->seeResponseIsJson();
        $I->seeResponseContains('"lnurl":"LNURL');
        $I->seeResponseContains('"ott":');
    ...
    public function getDisposableLnurlWithdrawFailWakiPak(\ApiTester $I)
    {
        $I->haveHttpHeader('Content-Type', 'application/json');
        $I->haveHttpHeader('X-Api-Key', 'pak_HgiUO4kskfneieivTI05Fm3YzTza4N');
        $I->sendGET('/v1/wallet/waki_aliceLnurlWithdraw/lnurl/withdraw');
    ...
    public function getDisposableLnurlWithdrawFailWakrPak(\ApiTester $I)
    {
        $I->haveHttpHeader('Content-Type', 'application/json');
        $I->haveHttpHeader('X-Api-Key', 'pak_HgiUO4kskfneieivTI05Fm3YzTza4N');
        $I->sendGET('/v1/wallet/wakr_aliceLnurlWithdraw/lnurl/withdraw');
        $I->seeResponseCodeIs(\Codeception\Util\HttpCode::UNAUTHORIZED);
        $I->seeResponseIsJson();
    }
    ...
    public function getDisposableLnurlWithdrawSuccessWakaPak(\ApiTester $I)
    {
        $I->haveHttpHeader('Content-Type', 'application/json');
        $I->haveHttpHeader('X-Api-Key', 'pak_HgiUO4kskfneieivTI05Fm3YzTza4N');
        $I->sendGET('/v1/wallet/waka_aliceLnurlWithdraw/lnurl/withdraw');
        $I->seeResponseCodeIs(\Codeception\Util\HttpCode::OK);
        $I->seeResponseIsJson();
        $I->seeResponseContains('"lnurl":"LNURL');
        $I->seeResponseContains('"ott":');

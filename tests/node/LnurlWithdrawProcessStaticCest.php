...
class LnurlWithdrawProcessStaticCest
{
    ...
    public function _before(ApiTester $I)
    {
        ...
        $I->sendGET('/v1/wallet/wal_aliceLnurlWithdraw/lnurl/withdraw-static?memo=Tester&num_satoshis=69');
    ...
    /**
     *
     * LNURLs generated from /lnurl/withdraw-static
     *
     *
     *
     */
    public function getLnurlProcessPreFetchSuccessStatic(\ApiTester $I)
    {
        codecept_debug($this->lnurlStatic);
        $I->sendGET($this->lnurlStatic);
        $I->seeResponseCodeIs(\Codeception\Util\HttpCode::OK);
        $I->seeResponseIsJson();
    ...
    public function getLnurlProcessFulfillPrSuccessStatic(\ApiTester $I)
    {
        codecept_debug($this->lnurlStatic);
        $I->sendGET($this->lnurlStatic);
        $I->seeResponseCodeIs(\Codeception\Util\HttpCode::OK);
        ...
        codecept_debug('callbackLnurl:'.$lnurl);
        ...
        //try again, since this is static should succeed
        expect($invoice = $this->generateTestInvoice(['value'=>69]));
        $I->sendGET($lnurl.'pr='.$invoice);
        $I->seeResponseContains('"OK"');
    }

    public function getLnurlProcessFulfillPrFailStatic(\ApiTester $I)
    {
        codecept_debug($this->lnurlStatic);
        $I->sendGET($this->lnurlStatic);
        $I->seeResponseCodeIs(\Codeception\Util\HttpCode::OK);
